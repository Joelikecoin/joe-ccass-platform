...
def test_ai_research_context_consumer_entry_unifies_access_delivery_and_quality(current_response, previous_response):
    ...
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery.governance_timeline_snapshot_delivery_state == "complete"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery.governance_timeline_snapshot_delivery_visible is True
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery
        is entry.consumer_boundary.governance_timeline_snapshot_delivery
    )
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_validation is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_validation.validation_state == "consistent"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_validation.governance_timeline_snapshot_delivery_visible is True
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_validation
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_validation
    )
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_summary is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_summary.governance_timeline_snapshot_delivery_summary_state == "complete"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_summary.governance_timeline_snapshot_delivery_summary_visible is True
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_summary
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_summary
    )
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_summary_validation is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_summary_validation.available is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_summary_validation.validation_state == "consistent"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_summary_validation.governance_timeline_snapshot_delivery_summary_visible is True
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_summary_validation
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_summary_validation
    )
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status.available is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status.governance_timeline_snapshot_delivery_status_state == "consistent"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status.governance_timeline_snapshot_delivery_status_visible is True
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_status
    )
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_validation is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_validation.available is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_validation.validation_state == "consistent"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_validation.governance_timeline_snapshot_delivery_status_visible is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary.available is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary.governance_timeline_snapshot_delivery_status_summary_state == "complete"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary.governance_timeline_snapshot_delivery_status_summary_visible is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation.available is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation.validation_state == "consistent"
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation.governance_timeline_snapshot_delivery_status_summary_visible is True
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_delivery is not None
    assert entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_delivery.available is True
    assert (
    ...
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_validation
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_status_validation
    )
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_validation_reference
        == entry.consumer_boundary.governance_timeline_snapshot_delivery_status_validation.validation_reference
    )
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary
    )
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary_reference
        == entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary.governance_timeline_snapshot_delivery_status_summary_reference
    )
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary_validation
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation
    )
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary_delivery
        is entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_delivery
    )
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary_delivery_reference
    ...
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary_validation_reference
        == entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation.validation_reference
    )
    ...
    assert (
        entry.consumer_boundary_governance_timeline_snapshot_delivery_reference
        == entry.consumer_boundary.governance_timeline_snapshot_delivery.governance_timeline_snapshot_delivery_reference
    )
    assert (
    ...
    assert "governance_timeline_snapshot_delivery_state=complete" in entry.summary
    assert "governance_timeline_snapshot_delivery_visible=yes" in entry.summary
    assert "governance_timeline_snapshot_delivery_validation_state=consistent" in entry.summary
    assert "governance_timeline_snapshot_delivery_validation_visible=yes" in entry.summary
    assert "governance_timeline_snapshot_delivery_summary_state=complete" in entry.summary
    assert "governance_timeline_snapshot_delivery_summary_visible=yes" in entry.summary
    assert "governance_timeline_snapshot_delivery_summary_validation_state=consistent" in entry.summary
    assert "governance_timeline_snapshot_delivery_summary_validation_visible=yes" in entry.summary
    ...
    assert "governance_timeline_snapshot_delivery_status_summary_delivery_reference=" in entry.summary
    assert "governance_timeline_snapshot_delivery_status_state=consistent" in entry.summary
    assert "governance_timeline_snapshot_delivery_status_visible=yes" in entry.summary
    assert "governance_timeline_snapshot_delivery_status_validation_state=consistent" in entry.summary
    assert "governance_timeline_snapshot_delivery_status_validation_visible=yes" in entry.summary
...
def test_ai_research_context_consumer_entry_handles_missing_assembly():
    ...
    assert entry.consumer_boundary_governance_timeline_snapshot_delivery_reference == "not available"
    assert entry.consumer_boundary_governance_timeline_snapshot_delivery_validation_reference == "not available"
    assert entry.consumer_boundary_governance_timeline_snapshot_delivery_summary_reference == "not available"
    assert entry.consumer_boundary_governance_timeline_snapshot_delivery_summary_validation_reference == "not available"
    assert entry.consumer_boundary_governance_timeline_snapshot_delivery_status_reference == "not available"
    assert entry.consumer_boundary_governance_timeline_snapshot_delivery_status_validation_reference == "not available"
...
def test_ai_research_context_consumer_entry_markdown_includes_delivery_output(current_response, previous_response):
    ...
    assert (
        ...
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Validation"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_validation_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_validation
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Summary"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_summary_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_summary
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Summary Validation"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_summary_validation_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_summary_validation
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Status"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_status
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Status Validation"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_validation_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_status_validation
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Status Summary"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_summary_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Status Summary Validation"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_summary_validation_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation
        )
    )
    assert (
        "AI Research Context Consumer Governance Timeline Snapshot Delivery Status Summary Delivery"
        in build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_summary_delivery_markdown(
            entry.consumer_boundary.governance_timeline_snapshot_delivery_status_summary_delivery
        )
    )
    ...
    assert markdown.find("recommendation") == -1
    assert markdown.find("trading signal") == -1
