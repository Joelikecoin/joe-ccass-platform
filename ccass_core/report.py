...
TRANSLATION_REGISTRY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "ui.raw_previews_no_sample_rows": "No sample rows available.",
        "ui.copy_for_chatgpt": "Copy for ChatGPT",
        "ui.copy_report": "Copy report",
        "ui.downloads_heading": "Downloads",
        ...
        "ui.downloads_combined_csv": "Combined CSV",
        "ui.downloads_excel_workbook": "Excel workbook",
        "ui.downloads_report_markdown": "Report Markdown",
        "ui.downloads_download_combined_csv": "Download combined CSV",
        "ui.downloads_download_excel_workbook": "Download Excel workbook",
        "ui.downloads_download_markdown_report": "Download Markdown report",
        "ui.downloads_csv_preview": "CSV preview",
        ...
        "report.no_additional_warning": "- No additional data-quality warning was generated.",
    ...
    "zh_HK": {
        ...
        "ui.raw_previews_heading": "????",
        "ui.raw_previews_expander": "???????",
        "ui.raw_previews_unavailable": "??????????????",
        "ui.raw_previews_caption": "??????????????????",
        "ui.raw_previews_table_index": "????",
        "ui.raw_previews_table_name": "????",
        "ui.raw_previews_shape": "??",
        "ui.raw_previews_columns": "??",
        "ui.raw_previews_no_sample_rows": "??????????",
        "ui.copy_for_chatgpt": "??? ChatGPT",
        "ui.copy_report": "????",
        "ui.downloads_heading": "??",
        "ui.downloads_unavailable": "??????????",
        "ui.downloads_caption": "??????????????????",
        "ui.downloads_combined_csv": "?? CSV",
        "ui.downloads_excel_workbook": "Excel ???",
        "ui.downloads_report_markdown": "?? Markdown",
        "ui.downloads_download_combined_csv": "???? CSV",
        "ui.downloads_download_excel_workbook": "?? Excel ???",
        "ui.downloads_download_markdown_report": "?? Markdown ??",
        "ui.downloads_csv_preview": "CSV ??",
