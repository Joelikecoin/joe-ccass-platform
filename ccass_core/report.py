...
TRANSLATION_REGISTRY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "ui.sidebar_use_local_history_caption": "Keeps comparison-based sections off the fast path unless you need them.",
        "ui.sidebar_load_price_history": "Load price history",
        "ui.sidebar_show_optional_heavy_sections": "Show optional deep research surfaces",
        "ui.sidebar_show_optional_heavy_sections_caption": "Hides raw previews and DT Rainbow until you choose to load them.",
        "ui.optional_heavy_sections_loading": "Loading optional deep research surfaces...",
        ...
        "ui.sidebar_show_broker_movement_timeline": "Show broker movement timeline (optional)",
        "ui.sidebar_show_broker_movement_timeline_caption": "Uses existing snapshot history only; keep it off for the fastest default view.",
        ...
        "ui.stock_events_heading": "Corporate Events",
        "ui.stock_events_caption": "Objective corporate event records are grouped here when available.",
        ...
        "ui.stock_events_source_ready": "Corporate events source is connected.",
        "ui.stock_events_source_pending": "Corporate events source is pending; the read path is wired but no live source is connected yet.",
        "ui.stock_events_empty": "No corporate event rows are available in the current result.",
        "ui.stock_events_unavailable": "Corporate event data is unavailable in the current fetch result.",
        ...
        "ui.full_summary_note_stock_events": "Corporate event surface is unavailable in the current result.",
        "ui.full_summary_note_stock_events_ready": "Corporate event surface is available from {source_name}.",
        "ui.full_summary_note_stock_events_pending": "Corporate event surface is present but the source is still pending.",
        ...
        "ui.full_summary_note_broker_movement_timeline": "Broker movement timeline is available on demand from local snapshot history.",
        "ui.full_summary_note_broker_movement_timeline_unavailable": "Broker movement timeline is unavailable in the current result.",
        "ui.full_summary_note_optional_heavy_sections": "Optional deep research surfaces stay hidden until you choose to load them.",
        ...
        "ui.research_dashboard_broker_movement_timeline": "Broker movement timeline",
        ...
        "ui.research_dashboard_link_broker_movement_timeline": "Broker movement timeline",
        ...
        "ui.research_dashboard_link_holder_changes": "Holder changes",
        "ui.holder_change_investigation_heading": "Holder change investigation",
        "ui.holder_change_investigation_caption": "A compact change-focused view that makes the biggest holder movements easier to spot.",
        "ui.holder_change_investigation_summary_heading": "Change summary",
        "ui.holder_change_investigation_top_changes_heading": "Top holder movements",
        "ui.holder_change_investigation_transfer_patterns_heading": "Potential transfer patterns",
        "ui.holder_change_investigation_previous_snapshot": "Previous snapshot",
        "ui.holder_change_investigation_change_count": "Change count",
        "ui.holder_change_investigation_big_change_count": "Big change count",
        "ui.holder_change_investigation_transfer_pattern_count": "Potential transfer patterns",
        "ui.ownership_distribution_heading": "Ownership distribution",
        "ui.ownership_distribution_caption": "A compact ownership view that makes the current concentration picture and the next investigation path easier to read.",
        "ui.ownership_distribution_top_holders_heading": "Top holders",
        "ui.ownership_distribution_change_focus_heading": "Change focus",
        "ui.ownership_distribution_participant_count": "Participant count",
        "ui.ownership_distribution_total_in_ccass_shares": "Total in CCASS shares",
        "ui.ownership_distribution_total_in_ccass_pct_of_issued": "Total in CCASS / issued",
        "ui.ownership_distribution_top5_pct_of_issued": "Top 5 / issued",
        "ui.ownership_distribution_top10_pct_of_issued": "Top 10 / issued",
        "ui.ownership_distribution_top5_pct_of_ccass": "Top 5 / CCASS",
        "ui.ownership_distribution_top10_pct_of_ccass": "Top 10 / CCASS",
        "ui.ownership_distribution_previous_snapshot": "Previous snapshot",
        ...
        "ui.downloads_raw_preview_json": "Raw Tables JSON",
        "ui.downloads_download_raw_preview_json": "Download Raw Tables JSON",
        ...
        "nav.stock_events": "Corporate Events",
        ...
        "report.section.stock_events": "## Corporate Events",
    ...
    "zh_HK": {
        ...
        "ui.sidebar_show_broker_movement_timeline": "顯示經紀人變動時間線（可選）",
        "ui.sidebar_show_broker_movement_timeline_caption": "只使用既有的 snapshot 歷史；保持關閉可維持最快的預設檢視。",
        "ui.sidebar_use_local_history_caption": "比較式章節會留在快速路徑之外，除非你需要它們。",
        "ui.sidebar_show_optional_heavy_sections": "顯示可選的深層研究區塊",
        "ui.sidebar_show_optional_heavy_sections_caption": "在你選擇載入前，先隱藏原始預覽與 DT Rainbow。",
        "ui.optional_heavy_sections_loading": "正在載入可選的深層研究區塊……",
        ...
        "ui.stock_events_heading": "企業活動",
        "ui.stock_events_caption": "如有可用，客觀企業活動紀錄會在此分組顯示。",
        "ui.stock_events_rows_label": "股份事件列表",
        "ui.stock_events_sorting_note": "當正式資料可用時，列會按事件日期由新到舊排序。",
        "ui.stock_events_source_ready": "企業活動資料來源已接通。",
        "ui.stock_events_source_pending": "企業活動資料來源仍在等待接通；讀取路徑已建立，但尚未連接正式資料源。",
        "ui.stock_events_empty": "目前結果沒有可用的企業活動列。",
        "ui.stock_events_unavailable": "目前的抓取結果沒有企業活動資料。",
        ...
        "ui.downloads_raw_preview_json": "原始表格 JSON",
        "ui.downloads_download_raw_preview_json": "下載原始表格 JSON",
        ...
        "ui.full_summary_note_stock_events": "目前結果沒有可用的企業活動表面。",
        "ui.full_summary_note_stock_events_ready": "企業活動表面已由 {source_name} 提供。",
        "ui.full_summary_note_stock_events_pending": "企業活動表面已就位，但資料來源仍在等待接通。",
        ...
        "ui.full_summary_note_broker_movement_timeline": "經紀人變動時間線可在本地 snapshot 歷史中按需顯示。",
        "ui.full_summary_note_broker_movement_timeline_unavailable": "目前結果沒有可用的經紀人變動時間線。",
        "ui.full_summary_note_optional_heavy_sections": "可選的深層研究區塊會在你選擇載入前保持隱藏。",
        ...
        "ui.research_dashboard_broker_movement_timeline": "經紀人變動時間線",
        ...
        "ui.research_dashboard_link_broker_movement_timeline": "經紀人變動時間線",
        ...
        "ui.research_dashboard_link_holder_changes": "持有人變動",
        "ui.holder_change_investigation_heading": "持有人變動研究",
        "ui.holder_change_investigation_caption": "以精簡方式呈現最重要的持有人變動，讓調查起點更容易辨認。",
        "ui.holder_change_investigation_summary_heading": "變動摘要",
        "ui.holder_change_investigation_top_changes_heading": "主要持有人變動",
        "ui.holder_change_investigation_transfer_patterns_heading": "潛在轉移模式",
        "ui.holder_change_investigation_previous_snapshot": "前一個 snapshot",
        "ui.holder_change_investigation_change_count": "變動數量",
        "ui.holder_change_investigation_big_change_count": "重大變動數量",
        "ui.holder_change_investigation_transfer_pattern_count": "潛在轉移模式數量",
        "ui.ownership_distribution_heading": "持股分布",
        "ui.ownership_distribution_caption": "以精簡方式呈現目前集中度與下一步調查方向，讓持股概況更易閱讀。",
        "ui.ownership_distribution_top_holders_heading": "主要持有人",
        "ui.ownership_distribution_change_focus_heading": "變動焦點",
        "ui.ownership_distribution_participant_count": "參與者數量",
        "ui.ownership_distribution_total_in_ccass_shares": "CCASS 內股份總數",
        "ui.ownership_distribution_total_in_ccass_pct_of_issued": "CCASS / 已發行股份",
        "ui.ownership_distribution_top5_pct_of_issued": "前五大 / 已發行股份",
        "ui.ownership_distribution_top10_pct_of_issued": "前十大 / 已發行股份",
        "ui.ownership_distribution_top5_pct_of_ccass": "前五大 / CCASS",
        "ui.ownership_distribution_top10_pct_of_ccass": "前十大 / CCASS",
        "ui.ownership_distribution_previous_snapshot": "前一個 snapshot",
        ...
        "report.section.stock_events": "## 企業活動",
        ...
        "report.no_changes_met_threshold": "No changes met the Big Changes threshold.",
