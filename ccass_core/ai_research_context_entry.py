...
class AIResearchContextConsumerEntry(BaseModel):
    ...
    consumer_boundary_governance_timeline_snapshot: AIResearchContextConsumerGovernanceTimelineSnapshot | None = None
    consumer_boundary_governance_timeline_snapshot_validation: AIResearchContextConsumerGovernanceTimelineSnapshotValidation | None = None
    ...
    consumer_boundary_governance_timeline_summary: AIResearchContextConsumerGovernanceTimelineSummary | None = None
    ...
    consumer_boundary_governance_timeline_summary_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_validation_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_summary: AIResearchContextConsumerGovernanceTimelineSnapshotSummary | None = None
    consumer_boundary_governance_timeline_snapshot_summary_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_summary_validation: AIResearchContextConsumerGovernanceTimelineSnapshotSummaryValidation | None = None
    ...
    consumer_boundary_governance_timeline_snapshot_delivery_summary: AIResearchContextConsumerGovernanceTimelineSnapshotDeliverySummary | None = None
    consumer_boundary_governance_timeline_snapshot_delivery_summary_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_delivery_summary_validation: AIResearchContextConsumerGovernanceTimelineSnapshotDeliverySummaryValidation | None = None
    consumer_boundary_governance_timeline_snapshot_delivery_summary_validation_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_delivery_status: AIResearchContextConsumerGovernanceTimelineSnapshotDeliveryStatus | None = None
    consumer_boundary_governance_timeline_snapshot_delivery_status_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_delivery_status_validation: AIResearchContextConsumerGovernanceTimelineSnapshotDeliveryStatusValidation | None = None
    consumer_boundary_governance_timeline_snapshot_delivery_status_validation_reference: str = "not available"
    consumer_boundary_governance_timeline_snapshot_delivery_status_summary: AIResearchContextConsumerGovernanceTimelineSnapshotDeliveryStatusSummary | None = None
...
def build_ai_research_context_consumer_entry(
    ...
    if not delivery.available:
        return AIResearchContextConsumerEntry(
            ...
            consumer_boundary_governance_timeline_summary=consumer_boundary.governance_timeline_summary
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot=consumer_boundary.governance_timeline_snapshot
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_validation=consumer_boundary.governance_timeline_snapshot_validation
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_summary=consumer_boundary.governance_timeline_snapshot_summary
            if consumer_boundary is not None
            else None,
            ...
            consumer_boundary_governance_timeline_summary_reference=(
                consumer_boundary.governance_timeline_summary.governance_timeline_summary_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_reference=(
                consumer_boundary.governance_timeline_snapshot.governance_timeline_snapshot_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_validation_reference=(
                consumer_boundary.governance_timeline_snapshot_validation.validation_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_summary_reference=(
                consumer_boundary.governance_timeline_snapshot_summary.governance_timeline_snapshot_summary_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_summary_validation=consumer_boundary.governance_timeline_snapshot_summary_validation
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_summary_validation_reference=(
                consumer_boundary.governance_timeline_snapshot_summary_validation.validation_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_delivery=consumer_boundary.governance_timeline_snapshot_delivery
            if consumer_boundary is not None
            else None,
            ...
            consumer_boundary_governance_timeline_snapshot_delivery_summary=consumer_boundary.governance_timeline_snapshot_delivery_summary
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_delivery_summary_reference=(
                consumer_boundary.governance_timeline_snapshot_delivery_summary.governance_timeline_snapshot_delivery_summary_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_delivery_summary_validation=consumer_boundary.governance_timeline_snapshot_delivery_summary_validation
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_delivery_summary_validation_reference=(
                consumer_boundary.governance_timeline_snapshot_delivery_summary_validation.validation_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_delivery_status=consumer_boundary.governance_timeline_snapshot_delivery_status
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_delivery_status_reference=(
                consumer_boundary.governance_timeline_snapshot_delivery_status.validation_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_delivery_status_validation=consumer_boundary.governance_timeline_snapshot_delivery_status_validation
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_delivery_status_validation_reference=(
                consumer_boundary.governance_timeline_snapshot_delivery_status_validation.validation_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_delivery_status_summary=consumer_boundary.governance_timeline_snapshot_delivery_status_summary
            if consumer_boundary is not None
            else None,
            consumer_boundary_governance_timeline_snapshot_delivery_status_summary_reference=(
                consumer_boundary.governance_timeline_snapshot_delivery_status_summary.governance_timeline_snapshot_delivery_status_summary_reference
                if consumer_boundary is not None
                else "not available"
            ),
            consumer_boundary_governance_timeline_snapshot_delivery_status_summary_validation=consumer_boundary.governance_timeline_snapshot_delivery_status_summary_validation
            if consumer_boundary is not None
            else None,
...
def build_ai_research_context_consumer_entry_markdown(
    ...
    rows = [
        ...
        (
            "Consumer boundary governance status validation state",
            (
                entry.consumer_boundary_governance_status_validation.validation_state
                if entry.consumer_boundary_governance_status_validation is not None
                else "not available"
            ),
        ),
        (
    ...
    if entry.consumer_boundary_governance_timeline_summary is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_summary_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_validation is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_validation_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_summary is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_summary_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_summary_validation is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_summary_validation_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_delivery is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_delivery_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_delivery_summary is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_delivery_summary_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_delivery_summary_validation is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_delivery_summary_validation_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_delivery_status is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_delivery_status_validation is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_validation_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_summary_markdown(
    ...
    if entry.consumer_boundary_governance_timeline_snapshot_delivery_status_summary_validation is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_snapshot_delivery_status_summary_validation_markdown(
    ...
    if entry.consumer_boundary_governance_timeline is not None:
        lines.extend(
            [
                "",
                build_ai_research_context_consumer_governance_timeline_markdown(
                    entry.consumer_boundary_governance_timeline
                ),
            ]
        )
    if entry.consumer_boundary_governance_snapshot is not None:
...
def _summary_text(
    *,
    ...
    governance_timeline_snapshot_delivery_status_validation_state: str,
    governance_timeline_snapshot_delivery_status_validation_visible: bool,
    ...
    return (
        ...
        f"governance_timeline_snapshot_delivery_status_validation_state={governance_timeline_snapshot_delivery_status_validation_state}; "
        f"governance_timeline_snapshot_delivery_status_validation_visible={'yes' if governance_timeline_snapshot_delivery_status_validation_visible else 'no'}; "
        f"governance_timeline_snapshot_delivery_status_summary_state={governance_timeline_snapshot_delivery_status_summary_state}; "
