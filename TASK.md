...
- `WEBB_NEGATIVE_HOLDINGS_FORENSICS_AND_BACKFILL_UNBLOCK_V1`：forensics completed; all 92 are source-native, with no parser/reconstruction generation and no safe automatic correction. Outcome C formal quarantine.
...
- Next executable stage：obtain authoritative semantics or approve a lineage-preserving quarantine policy, then rerun the data-quality and readiness gates.
