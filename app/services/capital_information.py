...
from app.sources.capital_information import CapitalInformationSource, PendingCapitalInformationSource


class CapitalInformationService:
    def __init__(self, source: CapitalInformationSource | None = None) -> None:
        self.source = source or PendingCapitalInformationSource()
