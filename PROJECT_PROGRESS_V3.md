...
3. **NEXT (§8 ROI order):** 🥈 **DI / Ownership timeline service** — 02318 has 628 DION rows persisted; build the per-filer 5-year increase/decrease timeline (CCASS inference becomes official fact). Then enrichment (beneficial_owner/placing_agent/adviser from DT data when Joe's gap data lands).
